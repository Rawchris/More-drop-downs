...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        button2 = dropDownBtn.init(frame: CGRect(x: 0, y: 0, width: 0, height: 0))
        ...
        button2.rightAnchor.constraint(equalTo: self.view.centerXAnchor, constant: -30).isActive = true
        ...
        button1.dropView.dropDownOptions = ["Option1", "Option2", "Option3"]
        button2.dropView.dropDownOptions = ["Option4", "Option5", "Option6"]
